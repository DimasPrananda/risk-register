<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('user.dashboard') }}" class="text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 hover:text-black">dashboard </a><a class="text-gray-800 dark:text-gray-200 font-bold">/ Pilih Periode</a>
    </x-slot>

    <div class="p-1 ml-20 max-w-7xl mx-auto overflow-x-auto mb-4">
        <form method="POST" action="{{ route('user.submit-periode') }}">
            @csrf
